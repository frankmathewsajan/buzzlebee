...
\begin{document}
	...
	\begin{onecolentry}
		\begin{highlights}
			...
			Coursework:} Data Structures and Algorithms, Operating Systems, Computer Networks, Database Management Systems (DBMS), Object-Oriented Programming Systems (OOPS).
		\end{highlights}
	\end{onecolentry}
