        ...
        <div className="flex items-center justify-between">
          <div className="flex items-center space-x-3">
            ...
            <p className="text-sm font-medium">
              <span className="font-semibold text-yellow-400">Development Notice:</span> This portfolio is currently in{" "}
              <span className="font-semibold">beta stage</span>. Some content may be placeholder data or subject to change.
            </p>
          </div>
          <button
