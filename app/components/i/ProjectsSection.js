          ...
          <div className="flex items-center justify-between mb-2">
            ...
            <div className="flex items-center gap-2">
              {project.badges?.AWARDED && (
                <div 
                  className="flex items-center gap-1 bg-gray-200 text-gray-500 px-2 py-1 rounded-full text-xs font-mono cursor-not-allowed opacity-60"
                >
              ...
              {project.badges?.DEPLOYED && (
                <div className="relative group/badge">
                  <span 
                    className="flex items-center gap-1 bg-green-100 text-green-700 px-2 py-1 rounded-full text-xs font-mono cursor-pointer hover:bg-green-200 transition-colors inline-flex"
                    onClick={(e) => {
                      e.stopPropagation();
